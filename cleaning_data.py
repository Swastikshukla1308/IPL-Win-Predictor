...
first_dataset = pd.read_csv(os.path.join(dataset_folder, "FIRST DATASET.csv"))
second_dataset = pd.read_csv(os.path.join(dataset_folder, "SECOND DATASET.csv"))
...
final_dataset.to_csv(os.path.join(dataset_folder, "FINAL DATASET.csv"), index=False)
...
pipe = Pipeline([('step1',trf),('step2',RandomForestClassifier(class_weight='balanced', random_state=100))])
